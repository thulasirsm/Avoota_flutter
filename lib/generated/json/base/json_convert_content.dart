...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<UserDataSupport>[] is M) {
      return data.map<UserDataSupport>((Map<String, dynamic> e) =>
          UserDataSupport.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (UserDataSupport).toString(): UserDataSupport.fromJson,
  };
